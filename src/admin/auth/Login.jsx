...
const Login = () => {
    ...
    const demoUsers = [
        { role: 'Super Admin', email: 'super@tripure.com', pass: 'admin123' },
        { role: 'Admin', email: 'admin@tripure.com', pass: 'admin123' },
        { role: 'Manager', email: 'manager@tripure.com', pass: 'admin123' },
    ];
